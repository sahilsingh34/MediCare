  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <Link href="/patient/doctors" className="bg-primary hover:bg-primary-hover text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-all shadow-lg shadow-primary/20 flex items-center gap-2 w-fit">
          <Stethoscope size={18} />
      ...
      {upcomingAppointments.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {upcomingAppointments.map((app) => (
            <div key={app.id} className="premium-card bg-white p-6 border border-gray-50 hover:border-primary/20 transition-all group">
              ...
              <div className="mt-6 flex gap-3">
                <button className="flex-1 bg-gray-50 hover:bg-gray-100 text-gray-700 py-2.5 rounded-xl text-sm font-medium transition-colors">
                  Reschedule
                </button>
                <button className="flex-1 bg-red-50 hover:bg-red-100 text-red-600 py-2.5 rounded-xl text-sm font-medium transition-colors">
                  Cancel
                </button>
              </div>
            </div>
